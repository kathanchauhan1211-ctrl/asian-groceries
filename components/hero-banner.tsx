      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="flex flex-col items-center gap-6 py-8 md:flex-row md:items-center md:gap-10 md:py-10 lg:py-12">
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left flex-1 min-w-0">
            ...
            {/* Brand name */}
            <h1 className="font-serif text-4xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl md:text-6xl">
              IndianMarket
              <span className="text-primary">.lt</span>
            </h1>

            {/* 3-word slogan */}
            <p className="mt-2 text-base font-medium text-slate-600 dark:text-slate-300 tracking-wide sm:text-lg">
